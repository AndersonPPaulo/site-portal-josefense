      ...
      <div className="flex flex-col justify-between px-4">
        <div className="flex flex-col md:flex-row mx-auto justify-between w-full p-4 gap-8">
          ...
          <div className="max-w-[380px]">
            ...
            <Image src={logo} alt="Portal Josefense" width={200} height={50} unoptimized/>
            </Link>
            <p className="mt-4 text-black font-[400] text-md">
              Sua fonte completa de notícias e comércios em São José
            </p>
        ...
        <div className="mt-12 pt-4 text-center text-sm text-gray-600">
          Copyright © 2025 Portal Josefense | Todos os direitos reservados
        </div>
      </div>
    </footer>
  );
