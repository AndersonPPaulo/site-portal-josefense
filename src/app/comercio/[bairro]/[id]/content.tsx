        ...
        <div className="rounded-lg mb-8">
          <div className="flex flex-col lg:flex-row gap-6 items-start">
            ...
            {company.linkWhatsapp && (
              <Button
                className="md:hidden flex bg-green-200 hover:bg-green-100 cursor-pointer mt-10 rounded-4xl px-4 text-green-600 items-center gap-2 w-full text-lg"
                variant="default"
            ...
            <div className="flex-1">
              ...
              {company.linkWhatsapp && (
                <Button
                  className="hidden md:flex bg-green-200 hover:bg-green-100 cursor-pointer mt-10 rounded-4xl px-4 py-2 text-green-600 items-center gap-2"
                  variant="default"
                  onClick={handleWhatsAppClick}
                >
                  <svg
