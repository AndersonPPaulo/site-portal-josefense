...
export async function generateMetadata({
  ...
  const title = `${categoriaNome} em São José | Portal Josefense`;
  const description = `Explore os melhores ${categoriaNome.toLowerCase()} em São José. Descubra serviços locais, empresas e muito mais na sua região.`;
  const keywords = [
    categoriaNome,
    "comércio local",
    "serviços",
